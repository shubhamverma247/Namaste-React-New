...
const resList = [
    {
      ...
      analytics: {
        context: "seo-data-e2c1c0ad-bc56-4856-9240-51b575970346",
      },
      cta: {
    ...
    },
    {
      ...
      cta: {
        link: "https://www.swiggy.com/restaurants/kakke-da-paratha-wakad-shankar-kalat-nagar-wakad-pune-260463",
        text: "RESTAURANT_MENU",
        type: "WEBLINK",
      },
      widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
    },
    {
      ...
      cta: {
        link: "https://www.swiggy.com/restaurants/apricot-veg-datta-mandir-road-wakad-pune-82112",
        text: "RESTAURANT_MENU",
        type: "WEBLINK",
      },
      widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
    ...
    },
    {
      info: {
        ...
        availability: {
          nextCloseTime: "2023-08-26 04:30:00",
          opened: true,
        },
        badges: {},
        isOpen: true,
    ...
    },
    {
      info: {
        id: "641221",
        name: "Shree Krishna Veg Court",
        cloudinaryImageId: "10fac46fd14aa38c40052ed0970096a7",
        locality: "Shanakr Kalat Nagar",
        areaName: "Wakad",
        costForTwo: "₹300 for two",
        cuisines: [
          "North Indian",
      ...
      cta: {
        link: "https://www.swiggy.com/restaurants/shree-krishna-veg-court-shanakr-kalat-nagar-wakad-pune-641221",
        text: "RESTAURANT_MENU",
        type: "WEBLINK",
      },
      widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
    },
    {
      ...
      cta: {
        link: "https://www.swiggy.com/restaurants/varuna-pure-veg-dutta-mandir-road-wakad-pune-9174",
        text: "RESTAURANT_MENU",
        type: "WEBLINK",
      },
      widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
...
const RestaunrentCard = (props) => {
    ...
    return (
        <div className="res-card" style={{backgroundColor:"#f0f0f0"}}>
            <img className="res-logo" alt="res-logo" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_1024/"+cloudinaryImageId} />
            <h3>{name}</h3>
            <h4>{cuisines.join(", ")}</h4>
